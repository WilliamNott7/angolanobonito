...
const text = "Obrigado pela visita! Aqui encontras minhas redes sociais, trabalhos realizados e contactos. Para propostas de parceria, colaboração ou contratação, usa o botão abaixo para falar diretamente comigo no WhatsApp.";
  let i = 0;
  function typing() {
    if (i < text.length) {
